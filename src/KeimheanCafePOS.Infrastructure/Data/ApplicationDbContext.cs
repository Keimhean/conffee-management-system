...
public class ApplicationDbContext : DbContext
{
    ...
    private void SeedData(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Product>().HasData(
            ...
            new Product { Id = 49, Name = "Peanut Butter Cookie", Price = 2.30m, Category = "Snack", ImageUrl = "https://entertainingwithbeth.com/wp-content/uploads/2018/09/PeanutButterCookie_6.jpg", CreatedAt = new DateTime(2025,11,23,9,39,43, DateTimeKind.Utc) },
