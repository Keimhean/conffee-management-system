...
public class ApplicationDbContext : DbContext
{
    ...
    private void SeedData(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Product>().HasData(
            ...
            // Updated image per user preference
            new Product { Id = 49, Name = "Peanut Butter Cookie", Price = 2.30m, Category = "Snack", ImageUrl = "/icons/photo/PeanutButterCookie.jpg", CreatedAt = new DateTime(2025,11,23,9,39,43, DateTimeKind.Utc) },
            new Product { Id = 50, Name = "Biscotti", Price = 2.50m, Category = "Snack", ImageUrl = "/icons/photo/Biscotti.jpg", CreatedAt = new DateTime(2025,11,23,9,39,43, DateTimeKind.Utc) },
            new Product { Id = 51, Name = "Granola Bar", Price = 2.80m, Category = "Snack", ImageUrl = "/icons/photo/GranolaBar.jpg", CreatedAt = new DateTime(2025,11,23,9,39,43, DateTimeKind.Utc) },
