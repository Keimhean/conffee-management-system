...
public class ApplicationDbContext : DbContext
{
    ...
    private void SeedData(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Product>().HasData(
            ...
            new Product { Id = 35, Name = "Chamomile Tea", Price = 3.00m, Category = "Tea", ImageUrl = "https://images.unsplash.com/photo-1563822249548-9a72b6d4b8e1?w=500&q=80", CreatedAt = new DateTime(2025,11,23,9,39,43, DateTimeKind.Utc) },
