...
public class ApplicationDbContext : DbContext
{
    ...
    private void SeedData(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Product>().HasData(
            ...
            new Product { Id = 49, Name = "Peanut Butter Cookie", Price = 2.30m, Category = "Snack", ImageUrl = "https://addapinch.com/wp-content/uploads/2023/11/peanut-butter-cookies-recipe-0013.jpg", CreatedAt = new DateTime(2025,11,23,9,39,43, DateTimeKind.Utc) },
